...
\"###########.######\" };")) t)
 ...
 '(package-selected-packages
   (quote
    (shackle 0xc delight meson-mode smart-backspace web-mode kaolin-themes smart-semicolon sunburn-theme org-tree-slide epresent flycheck-clang-analyzer magit smartparens zerodark-theme grayscale-theme avk-emacs-themes diredfl snazzy-theme exotica-theme flycheck-inline iqa default-text-scale modern-cpp-font-lock github-modern-theme imenu-list nubox zenburn-theme zen-and-art-theme yoshi-theme white-sand-theme which-key webpaste warm-night-theme waher-theme w3m visual-regexp-steroids utop use-package underwater-theme ujelly-theme ubuntu-theme twilight-theme twilight-bright-theme tuareg tronesque-theme tron-theme toxi-theme tommyh-theme theme-looper terminal-here termbright-theme tao-theme tangotango-theme tango-plus-theme tabbar-ruler systemd syslog-mode suscolors-theme sunny-day-theme sudo-edit sublime-themes subatomic256-theme subatomic-theme stekene-theme spacemacs-theme spaceline-all-the-icons spacegray-theme soothe-theme solarized-theme soft-stone-theme soft-morning-theme soft-charcoal-theme smyx-theme smart-newline slime-theme slime silkworm-theme shell-current-directory rust-mode rpm-spec-mode reykjavik-theme reverse-theme remember-last-theme rand-theme rainbow-delimiters railscasts-theme quasi-monochrome-theme qsimpleq-theme purple-haze-theme professional-theme pretty-sha-path portage-navi popwin polymode planet-theme pkgbuild-mode phoenix-dark-pink-theme phoenix-dark-mono-theme peacock-theme pastels-on-dark-theme pastelmac-theme paper-theme pandoc-mode pandoc organic-green-theme oldlace-theme ocp-indent ocodo-svg-modelines occidental-theme obsidian-theme noctilux-theme nix-mode nimbus-theme niceify-info neotree naquadah-theme muttrc-mode mustard-theme mustang-theme monokai-theme monochrome-theme molokai-theme moe-theme minimal-theme mellow-theme meghanada meacupla-theme mbo70s-theme matlab-mode material-theme markdown-mode+ majapahit-theme main-line lush-theme lua-mode llvm-mode liso-theme light-soap-theme leuven-theme lavender-theme late-night-theme labburn-theme kooten-theme jedi jbeans-theme jazz-theme ivy-rich irony-eldoc ir_black-theme ir-black-theme iodine-theme intellij-theme inkpot-theme ido-vertical-mode idea-darkula-theme hydandata-light-theme hipster-theme heroku-theme hemisu-theme hc-zenburn-theme hamburg-theme gruvbox-theme gruber-darker-theme greymatters-theme green-phosphor-theme graphviz-dot-mode grandshell-theme gotham-theme goose-theme google-translate github-theme gandalf-theme fringe-current-line forest-blue-theme folding fold-dwim flycheck-status-emoji flycheck-pos-tip flycheck-ocaml flycheck-irony flycheck-haskell flycheck-color-mode-line flatui-theme flatui-dark-theme flatland-theme flatland-black-theme firecode-theme firebelly-theme farmhouse-theme faff-theme eyebrowse espresso-theme emacs-eclim eink-theme eclipse-theme dracula-theme dokuwiki-mode django-theme distinguished-theme display-theme dired-sort-menu dired-rainbow dired+ debian-changelog-mode darktooth-theme darkmine-theme darkburn-theme dark-mint-theme dark-krystal-theme darcula-theme danneskjold-theme dakrone-theme cyberpunk-theme counsel company-web company-nixos-options company-math company-irony-c-headers company-irony company-ghc company-emoji company-auctex color-theme-sanityinc-tomorrow colonoscopy-theme cmake-project cmake-ide cmake-font-lock clues-theme clean-buffers challenger-deep-theme cdlatex caroline-theme calmer-forest-theme busybee-theme bubbleberry-theme boxquote boron-theme borland-blue-theme bliss-theme bison-mode birds-of-paradise-plus-theme basic-theme badwolf-theme badger-theme autumn-light-theme auto-complete-clang-async auto-complete-clang auto-complete-auctex aurora-theme auctex-latexmk atom-one-dark-theme atom-dark-theme arjen-grey-theme apropospriate-theme anti-zenburn-theme ample-zen-theme ample-theme alect-themes ahungry-theme afternoon-theme adoc-mode ac-html ac-haskell-process abyss-theme 4clojure 2048-game)))
